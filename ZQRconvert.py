...
# Prompt user about printer
print("Before you continue, make sure you have setup your label printer in zebra setup utilities with your desired settings/labels and make sure that printer is set as the default printer in windows.")

# Ask want to print
while True:
    print_choice = input("Do you want to print (1) Name Label, (2) Bluetooth MAC Label, (3) Both? ")
    if print_choice in ['1', '2', '3']:
        break  # Exit the loop if a valid choice was given
    else:
...
while True:
    ...
    for mac_address in mac_addresses:
        ...
        # Depending on the user's choice, create and print appropriate labels
        if print_choice == '1' or print_choice == '3':
        ...
        if print_choice == '2' or print_choice == '3':
